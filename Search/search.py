    ...
    while not st.isEmpty():
        ...
        if state not in visited:
            ...
            for i in problem.getSuccessors(state):
                new_state=i[0]
                direction=i[1]
                st.push((new_state,action+[direction]))
    ...
    while  not fringe.isEmpty():
        ...
        if state not in visited:
            ...
            for i in problem.getSuccessors(state):
                ...
                direction=i[1]
                incrementalcost=i[2]
                fringe.push((new_state,action+[direction],cost+incrementalcost),cost+incrementalcost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    q=util.PriorityQueue()
    strart_node=(problem.getStartState(), [] , 0)
    q.push(strart_node,0)
    visited=[]
        ...
        for i in problem.getSuccessors(state):
            ...
            if new_state not in visited:
                if problem.isGoalState(new_state):
                    ...
                    newcost=cost+incrementalcost
                    h=newcost+heuristic(new_state,problem)
                    q.push((new_state,action+[direction],newcost),h)
                    visited.append(newcost) """
